...
function Mines(scoreResults, uniqueDic, mapStats, mapObjectives) {
	...
	if (uniqueDic.hasOwnProperty('GolemLanes'))
		mapObjectives[19] = [
			[ uniqueDic['GolemLanes'][0]['m_intData'][0]['m_value'] - 1, 1 ],
			[ uniqueDic['GolemLanes'][0]['m_intData'][1]['m_value'] - 1, 0 ]
		]
}
...
function Checkpoint() {}
function Alterac() {}
function Foundry(mechCaptures, mapObjectives) {
	mapObjectives[26] = mechCaptures
}
